    ...
    def get_answer(self, user_sentence: str, intent_info: str = None, this_session: str = None):
        ...
        try:
            ...
            if existing_record:
                ...
                self._logger.info('previous dialogue state by {} is: {}'.format(self.this_session, self._prev_dialogue_state))
            else:
                self._logger.info('NEW dialogue state for {} is: {}'.format(self.this_session, self._prev_dialogue_state))
